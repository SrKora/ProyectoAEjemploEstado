...
fun EstadoLayout(
    ...
    // hay varios controles, así que necesitamos varias variables
...
fun BotonVolver(
    ...
    Button(
        onClick = { navController.navigate(Screens.Explicacion.name)}
    ) {
        Text("Volver")
    }
}
